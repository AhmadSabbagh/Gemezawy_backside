...
{
    public class SendAppolgieToUserIOS
    {
        public void SendNotification(string msg, string id, string comp_id)
        {
            ...
            jData.Add("body", msg);
            jData.Add("comp_id", comp_id);
            jFCMData.Add("priority", "high");
            jData.Add("title", "Dear Players");
            jFCMData.Add("to", "/topics/" + id + "_user");
